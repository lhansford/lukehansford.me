...
export default function Notes({ notes }: { notes: IContentItem<INote>[] }) {
  return (
    <Page title="Notes">
      <p>
        These are notes covering things I come across in my daily life. I was inspired
        by <a href="https://notes.andymatuschak.org/About_these_notes">Andy Matuschak's website</a> and
        reading about the <a href="https://en.wikipedia.org/wiki/Zettelkasten">Zettelkasten system</a>.
      </p>
