...
export default function Home() {
  return (
    <Page title="Home">
      <h2>Hey, I'm Luke</h2>
      <p>
        I'm a Stockholm based developer at{" "}
        <a href="https://fishbrain.com">Fishbrain</a>.
      </p>
      <p>
        I'm also the founder of the internet radio station{" "}
        <a href="https://frequency.asia">Frequency Asia</a>, co-founder of
        independent music label/magazine{" "}
        <a href="http://jingweir.tumblr.com/">Jingweir</a>, and an{" "}
        <a href="http://www.lukehansford.me/music.html">
          intermittent musician
        </a>
        .
      </p>
      <p>
